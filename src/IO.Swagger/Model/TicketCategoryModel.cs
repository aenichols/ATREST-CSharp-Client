...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TicketCategoryModel :  IEquatable<TicketCategoryModel>, IValidatableObject
    {
        /// <summary>
        ...
        public TicketCategoryModel(long? id = default(long?), int? displayColorRGB = default(int?), bool? isActive = default(bool?), bool? isApiOnly = default(bool?), bool? isGlobalDefault = default(bool?), string name = default(string), string nickname = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TicketCategoryModel);
        }

        /// <summary>
        /// Returns true if TicketCategoryModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketCategoryModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketCategoryModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsApiOnly == input.IsApiOnly ||
                    (this.IsApiOnly != null &&
                    this.IsApiOnly.Equals(input.IsApiOnly))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsApiOnly != null)
                    hashCode = hashCode * 59 + this.IsApiOnly.GetHashCode();
