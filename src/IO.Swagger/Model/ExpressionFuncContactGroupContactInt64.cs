...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactGroupContactInt64 :  IEquatable<ExpressionFuncContactGroupContactInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactGroupContactInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactGroupContactInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactGroupContactInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactGroupContactInt64 input)
        {
            if (input == null)
                return false;
