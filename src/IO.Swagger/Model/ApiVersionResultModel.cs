...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiVersionResultModel :  IEquatable<ApiVersionResultModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiVersionResultModel" /> class.
        /// </summary>
        /// <param name="apiVersions">apiVersions.</param>
        public ApiVersionResultModel(List<string> apiVersions = default(List<string>))
        {
        ...
        {
            return this.Equals(input as ApiVersionResultModel);
        }

        /// <summary>
        /// Returns true if ApiVersionResultModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiVersionResultModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiVersionResultModel input)
        {
            if (input == null)
                return false;
