...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractRetainerInt64 :  IEquatable<ExpressionFuncContractRetainerInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractRetainerInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractRetainerInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractRetainerInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractRetainerInt64 input)
        {
            if (input == null)
                return false;
