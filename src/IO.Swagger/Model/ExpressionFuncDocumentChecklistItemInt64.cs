...
{
    /// <summary>
    /// ExpressionFuncDocumentChecklistItemInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentChecklistItemInt64 :  IEquatable<ExpressionFuncDocumentChecklistItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentChecklistItemInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentChecklistItemInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentChecklistItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentChecklistItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentChecklistItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentChecklistItemInt64 input)
        {
            if (input == null)
                return false;
