...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountToDoInt64 :  IEquatable<ExpressionFuncAccountToDoInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountToDoInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountToDoInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountToDoInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountToDoInt64 input)
        {
            if (input == null)
                return false;
