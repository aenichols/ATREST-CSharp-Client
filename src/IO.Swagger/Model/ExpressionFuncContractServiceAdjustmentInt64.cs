...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractServiceAdjustmentInt64 :  IEquatable<ExpressionFuncContractServiceAdjustmentInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractServiceAdjustmentInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractServiceAdjustmentInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractServiceAdjustmentInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractServiceAdjustmentInt64 input)
        {
            if (input == null)
                return false;
