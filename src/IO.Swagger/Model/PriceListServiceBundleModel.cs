...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceListServiceBundleModel :  IEquatable<PriceListServiceBundleModel>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceListServiceBundleModel(long? id = default(long?), int? currencyID = default(int?), int? serviceBundleID = default(int?), double? unitPrice = default(double?), bool? usesInternalCurrencyPrice = default(bool?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PriceListServiceBundleModel);
        }

        /// <summary>
        /// Returns true if PriceListServiceBundleModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListServiceBundleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListServiceBundleModel input)
        {
            if (input == null)
                return false;
