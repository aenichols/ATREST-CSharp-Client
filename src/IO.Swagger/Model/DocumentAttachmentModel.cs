...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentAttachmentModel :  IEquatable<DocumentAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentAttachmentModel" /> class.
        /// </summary>
        ...
        public DocumentAttachmentModel(long? id = default(long?), DateTime? attachDate = default(DateTime?), long? attachedByContactID = default(long?), long? attachedByResourceID = default(long?), string attachmentType = default(string), string contentType = default(string), int? creatorType = default(int?), double? fileSize = default(double?), string fullPath = default(string), int? impersonatorCreatorResourceID = default(int?), long? opportunityID = default(long?), long? parentID = default(long?), string title = default(string), byte[] data = default(byte[]))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as DocumentAttachmentModel);
        }

        /// <summary>
        /// Returns true if DocumentAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentAttachmentModel input)
        {
            if (input == null)
                return false;
