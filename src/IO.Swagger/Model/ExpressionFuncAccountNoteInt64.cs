...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountNoteInt64 :  IEquatable<ExpressionFuncAccountNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountNoteInt64 input)
        {
            if (input == null)
                return false;
