...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeOrderChargeModel :  IEquatable<ChangeOrderChargeModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ChangeOrderChargeModel(long? id = default(long?), double? billableAmount = default(double?), int? billingCodeID = default(int?), double? changeOrderHours = default(double?), int? chargeType = default(int?), int? contractServiceBundleID = default(int?), int? contractServiceID = default(int?), DateTime? createDate = default(DateTime?), int? creatorResourceID = default(int?), DateTime? datePurchased = default(DateTime?), string description = default(string), double? extendedCost = default(double?), double? internalCurrencyBillableAmount = default(double?), double? internalCurrencyUnitPrice = default(double?), string internalPurchaseOrderNumber = default(string), bool? isBillableToCompany = default(bool?), bool? isBilled = default(bool?), string name = default(string), string notes = default(string), int? organizationalLevelAssociationID = default(int?), int? productID = default(int?), string purchaseOrderNumber = default(string), int? status = default(int?), int? statusLastModifiedBy = default(int?), DateTime? statusLastModifiedDate = default(DateTime?), int? taskID = default(int?), double? unitCost = default(double?), double? unitPrice = default(double?), double? unitQuantity = default(double?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ChangeOrderChargeModel);
        }

        /// <summary>
        /// Returns true if ChangeOrderChargeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeOrderChargeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeOrderChargeModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ChangeOrderHours == input.ChangeOrderHours ||
                    (this.ChangeOrderHours != null &&
                    this.ChangeOrderHours.Equals(input.ChangeOrderHours))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChangeOrderHours != null)
                    hashCode = hashCode * 59 + this.ChangeOrderHours.GetHashCode();
