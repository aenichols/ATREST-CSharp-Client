...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContractNoteModel :  IEquatable<ContractNoteModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ContractNoteModel(long? id = default(long?), int? contractID = default(int?), DateTime? createDateTime = default(DateTime?), int? creatorResourceID = default(int?), string description = default(string), int? impersonatorCreatorResourceID = default(int?), int? impersonatorUpdaterResourceID = default(int?), DateTime? lastActivityDate = default(DateTime?), string title = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ContractNoteModel);
        }

        /// <summary>
        /// Returns true if ContractNoteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractNoteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractNoteModel input)
        {
            if (input == null)
                return false;
