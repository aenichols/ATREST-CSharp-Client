...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpportunityAttachmentModel :  IEquatable<OpportunityAttachmentModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OpportunityAttachmentModel);
        }

        /// <summary>
        /// Returns true if OpportunityAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of OpportunityAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpportunityAttachmentModel input)
        {
            if (input == null)
                return false;
