...
{
    /// <summary>
    /// ExpressionFuncDocumentNoteInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentNoteInt64 :  IEquatable<ExpressionFuncDocumentNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentNoteInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentNoteInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentNoteInt64 input)
        {
            if (input == null)
                return false;
