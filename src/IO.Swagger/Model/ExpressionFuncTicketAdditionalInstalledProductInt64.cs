...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketAdditionalInstalledProductInt64 :  IEquatable<ExpressionFuncTicketAdditionalInstalledProductInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketAdditionalInstalledProductInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketAdditionalInstalledProductInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketAdditionalInstalledProductInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketAdditionalInstalledProductInt64 input)
        {
            if (input == null)
                return false;
