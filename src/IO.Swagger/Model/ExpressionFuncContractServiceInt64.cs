...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractServiceInt64 :  IEquatable<ExpressionFuncContractServiceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractServiceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractServiceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractServiceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractServiceInt64 input)
        {
            if (input == null)
                return false;
