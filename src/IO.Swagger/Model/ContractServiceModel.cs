...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContractServiceModel :  IEquatable<ContractServiceModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ContractServiceModel);
        }

        /// <summary>
        /// Returns true if ContractServiceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractServiceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractServiceModel input)
        {
            if (input == null)
                return false;
