...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemNoteModel :  IEquatable<ConfigurationItemNoteModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationItemNoteModel(long? id = default(long?), int? configurationItemID = default(int?), DateTime? createDateTime = default(DateTime?), int? creatorResourceID = default(int?), string description = default(string), int? impersonatorCreatorResourceID = default(int?), int? impersonatorUpdaterResourceID = default(int?), DateTime? lastActivityDate = default(DateTime?), int? noteType = default(int?), string title = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ConfigurationItemNoteModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemNoteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemNoteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemNoteModel input)
        {
            if (input == null)
                return false;
