...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncServiceCallTaskResourceInt64 :  IEquatable<ExpressionFuncServiceCallTaskResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncServiceCallTaskResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncServiceCallTaskResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncServiceCallTaskResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncServiceCallTaskResourceInt64 input)
        {
            if (input == null)
                return false;
