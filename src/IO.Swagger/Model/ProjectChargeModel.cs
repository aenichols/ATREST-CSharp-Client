...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectChargeModel :  IEquatable<ProjectChargeModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectChargeModel(long? id = default(long?), double? billableAmount = default(double?), long? billingCodeID = default(long?), int? chargeType = default(int?), long? contractServiceBundleID = default(long?), long? contractServiceID = default(long?), DateTime? createDate = default(DateTime?), long? creatorResourceID = default(long?), DateTime? datePurchased = default(DateTime?), string description = default(string), double? estimatedCost = default(double?), double? extendedCost = default(double?), double? internalCurrencyBillableAmount = default(double?), double? internalCurrencyUnitPrice = default(double?), string internalPurchaseOrderNumber = default(string), bool? isBillableToCompany = default(bool?), bool? isBilled = default(bool?), string name = default(string), string notes = default(string), int? organizationalLevelAssociationID = default(int?), long? productID = default(long?), long? projectID = default(long?), string purchaseOrderNumber = default(string), long? status = default(long?), long? statusLastModifiedBy = default(long?), DateTime? statusLastModifiedDate = default(DateTime?), double? unitCost = default(double?), double? unitPrice = default(double?), double? unitQuantity = default(double?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ProjectChargeModel);
        }

        /// <summary>
        /// Returns true if ProjectChargeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectChargeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectChargeModel input)
        {
            if (input == null)
                return false;
