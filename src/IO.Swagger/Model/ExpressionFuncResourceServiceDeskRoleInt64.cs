...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncResourceServiceDeskRoleInt64 :  IEquatable<ExpressionFuncResourceServiceDeskRoleInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncResourceServiceDeskRoleInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncResourceServiceDeskRoleInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncResourceServiceDeskRoleInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncResourceServiceDeskRoleInt64 input)
        {
            if (input == null)
                return false;
