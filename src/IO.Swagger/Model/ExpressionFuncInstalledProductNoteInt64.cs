...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncInstalledProductNoteInt64 :  IEquatable<ExpressionFuncInstalledProductNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncInstalledProductNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncInstalledProductNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncInstalledProductNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncInstalledProductNoteInt64 input)
        {
            if (input == null)
                return false;
