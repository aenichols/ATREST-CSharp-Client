...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncInventoryItemSerialNumberInt64 :  IEquatable<ExpressionFuncInventoryItemSerialNumberInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncInventoryItemSerialNumberInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncInventoryItemSerialNumberInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncInventoryItemSerialNumberInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncInventoryItemSerialNumberInt64 input)
        {
            if (input == null)
                return false;
