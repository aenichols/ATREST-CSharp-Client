...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountWebhookUdfFieldInt64 :  IEquatable<ExpressionFuncAccountWebhookUdfFieldInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountWebhookUdfFieldInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountWebhookUdfFieldInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountWebhookUdfFieldInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountWebhookUdfFieldInt64 input)
        {
            if (input == null)
                return false;
