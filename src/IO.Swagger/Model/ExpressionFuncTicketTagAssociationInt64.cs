...
{
    /// <summary>
    /// ExpressionFuncTicketTagAssociationInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketTagAssociationInt64 :  IEquatable<ExpressionFuncTicketTagAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncTicketTagAssociationInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncTicketTagAssociationInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncTicketTagAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketTagAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketTagAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketTagAssociationInt64 input)
        {
            if (input == null)
                return false;
