...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAttachmentInfoInt64 :  IEquatable<ExpressionFuncAttachmentInfoInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAttachmentInfoInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAttachmentInfoInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAttachmentInfoInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAttachmentInfoInt64 input)
        {
            if (input == null)
                return false;
