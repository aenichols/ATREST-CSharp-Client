...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncProductTierInt64 :  IEquatable<ExpressionFuncProductTierInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncProductTierInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncProductTierInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncProductTierInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncProductTierInt64 input)
        {
            if (input == null)
                return false;
