...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractExclusionSetExcludedRoleInt64 :  IEquatable<ExpressionFuncContractExclusionSetExcludedRoleInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractExclusionSetExcludedRoleInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractExclusionSetExcludedRoleInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractExclusionSetExcludedRoleInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractExclusionSetExcludedRoleInt64 input)
        {
            if (input == null)
                return false;
