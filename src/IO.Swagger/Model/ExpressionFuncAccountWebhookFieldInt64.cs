...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountWebhookFieldInt64 :  IEquatable<ExpressionFuncAccountWebhookFieldInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountWebhookFieldInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountWebhookFieldInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountWebhookFieldInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountWebhookFieldInt64 input)
        {
            if (input == null)
                return false;
