...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncResourceRoleQueueInt64 :  IEquatable<ExpressionFuncResourceRoleQueueInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncResourceRoleQueueInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncResourceRoleQueueInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncResourceRoleQueueInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncResourceRoleQueueInt64 input)
        {
            if (input == null)
                return false;
