...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceBundleModel :  IEquatable<ServiceBundleModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ServiceBundleModel(long? id = default(long?), int? billingCodeID = default(int?), DateTime? createDate = default(DateTime?), int? creatorResourceID = default(int?), string description = default(string), string invoiceDescription = default(string), bool? isActive = default(bool?), DateTime? lastModifiedDate = default(DateTime?), string name = default(string), double? percentageDiscount = default(double?), int? periodType = default(int?), long? serviceLevelAgreementID = default(long?), double? unitCost = default(double?), double? unitDiscount = default(double?), double? unitPrice = default(double?), int? updateResourceID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ServiceBundleModel);
        }

        /// <summary>
        /// Returns true if ServiceBundleModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceBundleModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceBundleModel input)
        {
            if (input == null)
                return false;
