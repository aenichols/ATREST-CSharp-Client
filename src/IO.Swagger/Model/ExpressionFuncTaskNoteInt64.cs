...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTaskNoteInt64 :  IEquatable<ExpressionFuncTaskNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTaskNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTaskNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTaskNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTaskNoteInt64 input)
        {
            if (input == null)
                return false;
