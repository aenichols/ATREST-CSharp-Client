...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractExclusionSetExcludedWorkTypeInt64 :  IEquatable<ExpressionFuncContractExclusionSetExcludedWorkTypeInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractExclusionSetExcludedWorkTypeInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractExclusionSetExcludedWorkTypeInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractExclusionSetExcludedWorkTypeInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractExclusionSetExcludedWorkTypeInt64 input)
        {
            if (input == null)
                return false;
