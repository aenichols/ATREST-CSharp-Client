...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemAttachmentModel :  IEquatable<ConfigurationItemAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConfigurationItemAttachmentModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemAttachmentModel input)
        {
            if (input == null)
                return false;
