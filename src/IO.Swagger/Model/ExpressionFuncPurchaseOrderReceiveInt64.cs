...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncPurchaseOrderReceiveInt64 :  IEquatable<ExpressionFuncPurchaseOrderReceiveInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncPurchaseOrderReceiveInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncPurchaseOrderReceiveInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncPurchaseOrderReceiveInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncPurchaseOrderReceiveInt64 input)
        {
            if (input == null)
                return false;
