...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactWebhookFieldModel :  IEquatable<ContactWebhookFieldModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactWebhookFieldModel(long? id = default(long?), int? fieldID = default(int?), bool? isDisplayAlwaysField = default(bool?), bool? isSubscribedField = default(bool?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ContactWebhookFieldModel);
        }

        /// <summary>
        /// Returns true if ContactWebhookFieldModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactWebhookFieldModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactWebhookFieldModel input)
        {
            if (input == null)
                return false;
