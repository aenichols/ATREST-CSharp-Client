...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProductNoteModel :  IEquatable<ProductNoteModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ProductNoteModel(long? id = default(long?), DateTime? createDateTime = default(DateTime?), int? creatorResourceID = default(int?), string description = default(string), int? impersonatorCreatorResourceID = default(int?), int? impersonatorUpdaterResourceID = default(int?), DateTime? lastActivityDate = default(DateTime?), int? productID = default(int?), string title = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ProductNoteModel);
        }

        /// <summary>
        /// Returns true if ProductNoteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductNoteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductNoteModel input)
        {
            if (input == null)
                return false;
