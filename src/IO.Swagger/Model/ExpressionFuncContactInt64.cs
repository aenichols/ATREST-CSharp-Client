...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactInt64 :  IEquatable<ExpressionFuncContactInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactInt64 input)
        {
            if (input == null)
                return false;
