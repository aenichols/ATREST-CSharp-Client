...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractFactorInt64 :  IEquatable<ExpressionFuncContractFactorInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractFactorInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractFactorInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractFactorInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractFactorInt64 input)
        {
            if (input == null)
                return false;
