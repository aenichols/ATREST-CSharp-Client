...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountPhysicalLocationInt64 :  IEquatable<ExpressionFuncAccountPhysicalLocationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountPhysicalLocationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountPhysicalLocationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountPhysicalLocationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountPhysicalLocationInt64 input)
        {
            if (input == null)
                return false;
