...
{
    /// <summary>
    /// ExpressionFuncDocumentChecklistLibraryInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentChecklistLibraryInt64 :  IEquatable<ExpressionFuncDocumentChecklistLibraryInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentChecklistLibraryInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentChecklistLibraryInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentChecklistLibraryInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentChecklistLibraryInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentChecklistLibraryInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentChecklistLibraryInt64 input)
        {
            if (input == null)
                return false;
