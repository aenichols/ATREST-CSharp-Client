...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactWebhookFieldInt64 :  IEquatable<ExpressionFuncContactWebhookFieldInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactWebhookFieldInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactWebhookFieldInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactWebhookFieldInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactWebhookFieldInt64 input)
        {
            if (input == null)
                return false;
