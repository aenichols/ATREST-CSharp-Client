...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncQuoteItemInt64 :  IEquatable<ExpressionFuncQuoteItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncQuoteItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncQuoteItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncQuoteItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncQuoteItemInt64 input)
        {
            if (input == null)
                return false;
