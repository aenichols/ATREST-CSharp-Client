...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractRateInt64 :  IEquatable<ExpressionFuncContractRateInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractRateInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractRateInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractRateInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractRateInt64 input)
        {
            if (input == null)
                return false;
