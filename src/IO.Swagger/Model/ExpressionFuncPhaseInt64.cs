...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncPhaseInt64 :  IEquatable<ExpressionFuncPhaseInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncPhaseInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncPhaseInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncPhaseInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncPhaseInt64 input)
        {
            if (input == null)
                return false;
