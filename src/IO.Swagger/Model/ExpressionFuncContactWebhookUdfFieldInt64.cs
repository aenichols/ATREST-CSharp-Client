...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactWebhookUdfFieldInt64 :  IEquatable<ExpressionFuncContactWebhookUdfFieldInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactWebhookUdfFieldInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactWebhookUdfFieldInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactWebhookUdfFieldInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactWebhookUdfFieldInt64 input)
        {
            if (input == null)
                return false;
