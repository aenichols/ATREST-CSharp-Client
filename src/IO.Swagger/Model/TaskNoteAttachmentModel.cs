...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskNoteAttachmentModel :  IEquatable<TaskNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TaskNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if TaskNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskNoteAttachmentModel input)
        {
            if (input == null)
                return false;
