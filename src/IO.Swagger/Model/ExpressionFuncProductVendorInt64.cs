...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncProductVendorInt64 :  IEquatable<ExpressionFuncProductVendorInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncProductVendorInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncProductVendorInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncProductVendorInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncProductVendorInt64 input)
        {
            if (input == null)
                return false;
