...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketNoteInt64 :  IEquatable<ExpressionFuncTicketNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketNoteInt64 input)
        {
            if (input == null)
                return false;
