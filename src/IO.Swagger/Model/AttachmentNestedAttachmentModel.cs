...
{
    /// <summary>
    /// AttachmentNestedAttachmentModel
    /// </summary>
    [DataContract]
    public partial class AttachmentNestedAttachmentModel :  IEquatable<AttachmentNestedAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentNestedAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AttachmentNestedAttachmentModel);
        }

        /// <summary>
        /// Returns true if AttachmentNestedAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentNestedAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentNestedAttachmentModel input)
        {
            if (input == null)
                return false;
