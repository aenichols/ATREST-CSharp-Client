...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemWebhookUdfFieldModel :  IEquatable<ConfigurationItemWebhookUdfFieldModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemWebhookUdfFieldModel" /> class.
        /// </summary>
        ...
        public ConfigurationItemWebhookUdfFieldModel(long? id = default(long?), bool? isDisplayAlwaysField = default(bool?), bool? isSubscribedField = default(bool?), int? udfFieldID = default(int?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ConfigurationItemWebhookUdfFieldModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemWebhookUdfFieldModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemWebhookUdfFieldModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemWebhookUdfFieldModel input)
        {
            if (input == null)
                return false;
