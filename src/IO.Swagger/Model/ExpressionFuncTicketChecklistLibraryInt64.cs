...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketChecklistLibraryInt64 :  IEquatable<ExpressionFuncTicketChecklistLibraryInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketChecklistLibraryInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketChecklistLibraryInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketChecklistLibraryInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketChecklistLibraryInt64 input)
        {
            if (input == null)
                return false;
