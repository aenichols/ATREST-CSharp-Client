...
{
    /// <summary>
    /// ExpressionFuncTagAliasInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTagAliasInt64 :  IEquatable<ExpressionFuncTagAliasInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncTagAliasInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncTagAliasInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncTagAliasInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTagAliasInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTagAliasInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTagAliasInt64 input)
        {
            if (input == null)
                return false;
