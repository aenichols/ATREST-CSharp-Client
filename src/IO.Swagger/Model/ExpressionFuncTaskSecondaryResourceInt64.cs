...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTaskSecondaryResourceInt64 :  IEquatable<ExpressionFuncTaskSecondaryResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTaskSecondaryResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTaskSecondaryResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTaskSecondaryResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTaskSecondaryResourceInt64 input)
        {
            if (input == null)
                return false;
