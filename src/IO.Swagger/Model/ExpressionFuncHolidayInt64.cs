...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncHolidayInt64 :  IEquatable<ExpressionFuncHolidayInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncHolidayInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncHolidayInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncHolidayInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncHolidayInt64 input)
        {
            if (input == null)
                return false;
