...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountTeamInt64 :  IEquatable<ExpressionFuncAccountTeamInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountTeamInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountTeamInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountTeamInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountTeamInt64 input)
        {
            if (input == null)
                return false;
