...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketAdditionalContactInt64 :  IEquatable<ExpressionFuncTicketAdditionalContactInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketAdditionalContactInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketAdditionalContactInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketAdditionalContactInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketAdditionalContactInt64 input)
        {
            if (input == null)
                return false;
