...
{
    /// <summary>
    /// ExpressionFuncDocumentTicketAssociationInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentTicketAssociationInt64 :  IEquatable<ExpressionFuncDocumentTicketAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentTicketAssociationInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentTicketAssociationInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentTicketAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentTicketAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentTicketAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentTicketAssociationInt64 input)
        {
            if (input == null)
                return false;
