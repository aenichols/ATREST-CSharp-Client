...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncSalesOrderInt64 :  IEquatable<ExpressionFuncSalesOrderInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncSalesOrderInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncSalesOrderInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncSalesOrderInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncSalesOrderInt64 input)
        {
            if (input == null)
                return false;
