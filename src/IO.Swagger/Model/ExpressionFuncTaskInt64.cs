...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTaskInt64 :  IEquatable<ExpressionFuncTaskInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTaskInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTaskInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTaskInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTaskInt64 input)
        {
            if (input == null)
                return false;
