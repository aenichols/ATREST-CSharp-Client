...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncServiceBundleServiceInt64 :  IEquatable<ExpressionFuncServiceBundleServiceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncServiceBundleServiceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncServiceBundleServiceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncServiceBundleServiceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncServiceBundleServiceInt64 input)
        {
            if (input == null)
                return false;
