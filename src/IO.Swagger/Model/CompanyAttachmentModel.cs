...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyAttachmentModel :  IEquatable<CompanyAttachmentModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CompanyAttachmentModel);
        }

        /// <summary>
        /// Returns true if CompanyAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyAttachmentModel input)
        {
            if (input == null)
                return false;
