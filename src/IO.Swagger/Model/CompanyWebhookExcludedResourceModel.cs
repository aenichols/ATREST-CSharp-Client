...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyWebhookExcludedResourceModel :  IEquatable<CompanyWebhookExcludedResourceModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyWebhookExcludedResourceModel(long? id = default(long?), int? resourceID = default(int?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CompanyWebhookExcludedResourceModel);
        }

        /// <summary>
        /// Returns true if CompanyWebhookExcludedResourceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyWebhookExcludedResourceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyWebhookExcludedResourceModel input)
        {
            if (input == null)
                return false;
