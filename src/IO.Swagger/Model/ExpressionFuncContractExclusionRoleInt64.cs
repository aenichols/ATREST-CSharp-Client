...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractExclusionRoleInt64 :  IEquatable<ExpressionFuncContractExclusionRoleInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractExclusionRoleInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractExclusionRoleInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractExclusionRoleInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractExclusionRoleInt64 input)
        {
            if (input == null)
                return false;
