...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesOrderAttachmentModel :  IEquatable<SalesOrderAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOrderAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SalesOrderAttachmentModel);
        }

        /// <summary>
        /// Returns true if SalesOrderAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesOrderAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesOrderAttachmentModel input)
        {
            if (input == null)
                return false;
