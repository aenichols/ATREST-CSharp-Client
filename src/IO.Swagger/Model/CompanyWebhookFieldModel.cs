...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyWebhookFieldModel :  IEquatable<CompanyWebhookFieldModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyWebhookFieldModel(long? id = default(long?), int? fieldID = default(int?), bool? isDisplayAlwaysField = default(bool?), bool? isSubscribedField = default(bool?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CompanyWebhookFieldModel);
        }

        /// <summary>
        /// Returns true if CompanyWebhookFieldModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyWebhookFieldModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyWebhookFieldModel input)
        {
            if (input == null)
                return false;
