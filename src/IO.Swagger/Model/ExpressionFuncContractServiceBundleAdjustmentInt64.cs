...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractServiceBundleAdjustmentInt64 :  IEquatable<ExpressionFuncContractServiceBundleAdjustmentInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractServiceBundleAdjustmentInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractServiceBundleAdjustmentInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractServiceBundleAdjustmentInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractServiceBundleAdjustmentInt64 input)
        {
            if (input == null)
                return false;
