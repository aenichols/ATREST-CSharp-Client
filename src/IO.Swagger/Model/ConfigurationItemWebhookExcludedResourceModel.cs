...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemWebhookExcludedResourceModel :  IEquatable<ConfigurationItemWebhookExcludedResourceModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemWebhookExcludedResourceModel" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="resourceID">resourceID.</param>
        /// <param name="webhookID">webhookID.</param>
        /// <param name="userDefinedFields">userDefinedFields.</param>
        public ConfigurationItemWebhookExcludedResourceModel(long? id = default(long?), int? resourceID = default(int?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ConfigurationItemWebhookExcludedResourceModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemWebhookExcludedResourceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemWebhookExcludedResourceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemWebhookExcludedResourceModel input)
        {
            if (input == null)
                return false;
