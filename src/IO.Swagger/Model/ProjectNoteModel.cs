...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectNoteModel :  IEquatable<ProjectNoteModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectNoteModel(long? id = default(long?), DateTime? createDateTime = default(DateTime?), int? createdByContactID = default(int?), int? creatorResourceID = default(int?), string description = default(string), int? impersonatorCreatorResourceID = default(int?), int? impersonatorUpdaterResourceID = default(int?), bool? isAnnouncement = default(bool?), DateTime? lastActivityDate = default(DateTime?), int? noteType = default(int?), int? projectID = default(int?), int? publish = default(int?), string title = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ProjectNoteModel);
        }

        /// <summary>
        /// Returns true if ProjectNoteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectNoteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectNoteModel input)
        {
            if (input == null)
                return false;
