...
{
    /// <summary>
    /// ExpressionFuncDocumentInstalledProductAssociationInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentInstalledProductAssociationInt64 :  IEquatable<ExpressionFuncDocumentInstalledProductAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentInstalledProductAssociationInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentInstalledProductAssociationInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentInstalledProductAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentInstalledProductAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentInstalledProductAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentInstalledProductAssociationInt64 input)
        {
            if (input == null)
                return false;
