...
{
    /// <summary>
    /// ExpressionFuncDocumentPlainTextContentInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentPlainTextContentInt64 :  IEquatable<ExpressionFuncDocumentPlainTextContentInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentPlainTextContentInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentPlainTextContentInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentPlainTextContentInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentPlainTextContentInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentPlainTextContentInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentPlainTextContentInt64 input)
        {
            if (input == null)
                return false;
