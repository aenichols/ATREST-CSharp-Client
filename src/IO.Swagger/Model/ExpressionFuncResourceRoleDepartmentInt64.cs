...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncResourceRoleDepartmentInt64 :  IEquatable<ExpressionFuncResourceRoleDepartmentInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncResourceRoleDepartmentInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncResourceRoleDepartmentInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncResourceRoleDepartmentInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncResourceRoleDepartmentInt64 input)
        {
            if (input == null)
                return false;
