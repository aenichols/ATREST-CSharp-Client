...
{
    /// <summary>
    /// ExpressionFuncDocumentInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentInt64 :  IEquatable<ExpressionFuncDocumentInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentInt64 input)
        {
            if (input == null)
                return false;
