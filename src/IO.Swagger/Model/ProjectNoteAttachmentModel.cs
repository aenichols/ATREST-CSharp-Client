...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectNoteAttachmentModel :  IEquatable<ProjectNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProjectNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if ProjectNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectNoteAttachmentModel input)
        {
            if (input == null)
                return false;
