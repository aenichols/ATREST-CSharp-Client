...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncPriceListProductTierInt64 :  IEquatable<ExpressionFuncPriceListProductTierInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncPriceListProductTierInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncPriceListProductTierInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncPriceListProductTierInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncPriceListProductTierInt64 input)
        {
            if (input == null)
                return false;
