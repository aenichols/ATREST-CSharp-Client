...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncServiceCallTicketResourceInt64 :  IEquatable<ExpressionFuncServiceCallTicketResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncServiceCallTicketResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncServiceCallTicketResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncServiceCallTicketResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncServiceCallTicketResourceInt64 input)
        {
            if (input == null)
                return false;
