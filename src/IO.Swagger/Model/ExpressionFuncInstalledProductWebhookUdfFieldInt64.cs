...
{
    /// <summary>
    /// ExpressionFuncInstalledProductWebhookUdfFieldInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncInstalledProductWebhookUdfFieldInt64 :  IEquatable<ExpressionFuncInstalledProductWebhookUdfFieldInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncInstalledProductWebhookUdfFieldInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncInstalledProductWebhookUdfFieldInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncInstalledProductWebhookUdfFieldInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncInstalledProductWebhookUdfFieldInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncInstalledProductWebhookUdfFieldInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncInstalledProductWebhookUdfFieldInt64 input)
        {
            if (input == null)
                return false;
