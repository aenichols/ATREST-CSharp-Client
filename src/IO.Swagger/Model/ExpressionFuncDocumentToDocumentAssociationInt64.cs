...
{
    /// <summary>
    /// ExpressionFuncDocumentToDocumentAssociationInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentToDocumentAssociationInt64 :  IEquatable<ExpressionFuncDocumentToDocumentAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentToDocumentAssociationInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentToDocumentAssociationInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentToDocumentAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentToDocumentAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentToDocumentAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentToDocumentAssociationInt64 input)
        {
            if (input == null)
                return false;
