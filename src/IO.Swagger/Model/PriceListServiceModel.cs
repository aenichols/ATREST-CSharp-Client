...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceListServiceModel :  IEquatable<PriceListServiceModel>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceListServiceModel(long? id = default(long?), int? currencyID = default(int?), int? serviceID = default(int?), double? unitPrice = default(double?), bool? usesInternalCurrencyPrice = default(bool?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PriceListServiceModel);
        }

        /// <summary>
        /// Returns true if PriceListServiceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListServiceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListServiceModel input)
        {
            if (input == null)
                return false;
