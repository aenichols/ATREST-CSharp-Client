...
{
    /// <summary>
    /// ExpressionFuncDocumentTagAssociationInt64
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncDocumentTagAssociationInt64 :  IEquatable<ExpressionFuncDocumentTagAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressionFuncDocumentTagAssociationInt64" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ExpressionFuncDocumentTagAssociationInt64()
        {
        }
        ...
        {
            return this.Equals(input as ExpressionFuncDocumentTagAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncDocumentTagAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncDocumentTagAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncDocumentTagAssociationInt64 input)
        {
            if (input == null)
                return false;
