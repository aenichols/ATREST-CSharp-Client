...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenseReportAttachmentModel :  IEquatable<ExpenseReportAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseReportAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExpenseReportAttachmentModel);
        }

        /// <summary>
        /// Returns true if ExpenseReportAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseReportAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseReportAttachmentModel input)
        {
            if (input == null)
                return false;
