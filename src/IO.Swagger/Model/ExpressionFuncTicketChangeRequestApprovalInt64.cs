...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketChangeRequestApprovalInt64 :  IEquatable<ExpressionFuncTicketChangeRequestApprovalInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketChangeRequestApprovalInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketChangeRequestApprovalInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketChangeRequestApprovalInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketChangeRequestApprovalInt64 input)
        {
            if (input == null)
                return false;
