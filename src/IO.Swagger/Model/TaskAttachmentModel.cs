...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskAttachmentModel :  IEquatable<TaskAttachmentModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TaskAttachmentModel);
        }

        /// <summary>
        /// Returns true if TaskAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskAttachmentModel input)
        {
            if (input == null)
                return false;
