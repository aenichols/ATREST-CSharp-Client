...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncProjectNoteInt64 :  IEquatable<ExpressionFuncProjectNoteInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncProjectNoteInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncProjectNoteInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncProjectNoteInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncProjectNoteInt64 input)
        {
            if (input == null)
                return false;
