...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncServiceCallTicketInt64 :  IEquatable<ExpressionFuncServiceCallTicketInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncServiceCallTicketInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncServiceCallTicketInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncServiceCallTicketInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncServiceCallTicketInt64 input)
        {
            if (input == null)
                return false;
