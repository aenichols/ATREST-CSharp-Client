...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactBillingProductAssociationInt64 :  IEquatable<ExpressionFuncContactBillingProductAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactBillingProductAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactBillingProductAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactBillingProductAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactBillingProductAssociationInt64 input)
        {
            if (input == null)
                return false;
