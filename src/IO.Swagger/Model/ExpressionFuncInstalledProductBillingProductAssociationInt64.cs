...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncInstalledProductBillingProductAssociationInt64 :  IEquatable<ExpressionFuncInstalledProductBillingProductAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncInstalledProductBillingProductAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncInstalledProductBillingProductAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncInstalledProductBillingProductAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncInstalledProductBillingProductAssociationInt64 input)
        {
            if (input == null)
                return false;
