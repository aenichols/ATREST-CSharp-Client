...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractServiceBundleInt64 :  IEquatable<ExpressionFuncContractServiceBundleInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractServiceBundleInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractServiceBundleInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractServiceBundleInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractServiceBundleInt64 input)
        {
            if (input == null)
                return false;
