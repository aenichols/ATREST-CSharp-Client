...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractMilestoneInt64 :  IEquatable<ExpressionFuncContractMilestoneInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractMilestoneInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractMilestoneInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractMilestoneInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractMilestoneInt64 input)
        {
            if (input == null)
                return false;
