...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactWebhookModel :  IEquatable<ContactWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ContactWebhookModel);
        }

        /// <summary>
        /// Returns true if ContactWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactWebhookModel input)
        {
            if (input == null)
                return false;
