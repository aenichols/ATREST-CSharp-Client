...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemWebhookModel :  IEquatable<ConfigurationItemWebhookModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemWebhookModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConfigurationItemWebhookModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemWebhookModel input)
        {
            if (input == null)
                return false;
