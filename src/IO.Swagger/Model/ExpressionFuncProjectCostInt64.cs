...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncProjectCostInt64 :  IEquatable<ExpressionFuncProjectCostInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncProjectCostInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncProjectCostInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncProjectCostInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncProjectCostInt64 input)
        {
            if (input == null)
                return false;
