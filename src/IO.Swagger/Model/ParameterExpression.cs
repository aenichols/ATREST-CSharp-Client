...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParameterExpression :  IEquatable<ParameterExpression>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ParameterExpression);
        }

        /// <summary>
        /// Returns true if ParameterExpression instances are equal
        /// </summary>
        /// <param name="input">Instance of ParameterExpression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParameterExpression input)
        {
            if (input == null)
                return false;
