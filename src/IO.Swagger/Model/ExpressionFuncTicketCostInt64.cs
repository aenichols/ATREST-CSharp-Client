...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketCostInt64 :  IEquatable<ExpressionFuncTicketCostInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketCostInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketCostInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketCostInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketCostInt64 input)
        {
            if (input == null)
                return false;
