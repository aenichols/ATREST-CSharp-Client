...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectAttachmentModel :  IEquatable<ProjectAttachmentModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProjectAttachmentModel);
        }

        /// <summary>
        /// Returns true if ProjectAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectAttachmentModel input)
        {
            if (input == null)
                return false;
