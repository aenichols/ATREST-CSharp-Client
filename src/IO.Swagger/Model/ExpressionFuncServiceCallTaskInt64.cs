...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncServiceCallTaskInt64 :  IEquatable<ExpressionFuncServiceCallTaskInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncServiceCallTaskInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncServiceCallTaskInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncServiceCallTaskInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncServiceCallTaskInt64 input)
        {
            if (input == null)
                return false;
