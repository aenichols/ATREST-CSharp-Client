...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractBlockInt64 :  IEquatable<ExpressionFuncContractBlockInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractBlockInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractBlockInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractBlockInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractBlockInt64 input)
        {
            if (input == null)
                return false;
