...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemExtModel :  IEquatable<ConfigurationItemExtModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationItemExtModel(long? id = default(long?), int? apiVendorID = default(int?), int? companyID = default(int?), int? companyLocationID = default(int?), int? configurationItemCategoryID = default(int?), int? configurationItemType = default(int?), int? contactID = default(int?), int? contractID = default(int?), int? contractServiceBundleID = default(int?), int? contractServiceID = default(int?), DateTime? createDate = default(DateTime?), int? createdByPersonID = default(int?), double? dailyCost = default(double?), long? dattoAvailableKilobytes = default(long?), int? dattoDeviceMemoryMegabytes = default(int?), bool? dattoDrivesErrors = default(bool?), string dattoHostname = default(string), string dattoInternalIP = default(string), string dattoKernelVersionID = default(string), DateTime? dattoLastCheckInDateTime = default(DateTime?), int? dattoNICSpeedKilobitsPerSecond = default(int?), int? dattoNumberOfAgents = default(int?), int? dattoNumberOfDrives = default(int?), int? dattoNumberOfVolumes = default(int?), long? dattoOffsiteUsedBytes = default(long?), string dattoOSVersionID = default(string), double? dattoPercentageUsed = default(double?), long? dattoProtectedKilobytes = default(long?), string dattoRemoteIP = default(string), string dattoSerialNumber = default(string), int? dattoUptimeSeconds = default(int?), long? dattoUsedKilobytes = default(long?), string dattoZFSVersionID = default(string), string deviceNetworkingID = default(string), string domain = default(string), int? domainRegistrarID = default(int?), DateTime? domainRegistrationDateTime = default(DateTime?), DateTime? domainLastUpdatedDateTime = default(DateTime?), DateTime? domainExpirationDateTime = default(DateTime?), double? hourlyCost = default(double?), int? impersonatorCreatorResourceID = default(int?), DateTime? installDate = default(DateTime?), int? installedByContactID = default(int?), int? installedByID = default(int?), bool? isActive = default(bool?), int? lastActivityPersonID = default(int?), int? lastActivityPersonType = default(int?), DateTime? lastModifiedTime = default(DateTime?), string location = default(string), double? monthlyCost = default(double?), string notes = default(string), double? numberOfUsers = default(double?), int? parentConfigurationItemID = default(int?), double? perUseCost = default(double?), int? productID = default(int?), string referenceNumber = default(string), string referenceTitle = default(string), string rmmDeviceAuditAntivirusStatusID = default(string), string rmmDeviceAuditArchitectureID = default(string), string rmmDeviceAuditBackupStatusID = default(string), string rmmDeviceAuditDescription = default(string), string rmmDeviceAuditDeviceTypeID = default(string), string rmmDeviceAuditDisplayAdaptorID = default(string), string rmmDeviceAuditDomainID = default(string), string rmmDeviceAuditExternalIPAddress = default(string), string rmmDeviceAuditHostname = default(string), string rmmDeviceAuditIPAddress = default(string), string rmmDeviceAuditLastUser = default(string), string rmmDeviceAuditMacAddress = default(string), string rmmDeviceAuditManufacturerID = default(string), long? rmmDeviceAuditMemoryBytes = default(long?), int? rmmDeviceAuditMissingPatchCount = default(int?), string rmmDeviceAuditMobileNetworkOperatorID = default(string), string rmmDeviceAuditMobileNumber = default(string), string rmmDeviceAuditModelID = default(string), string rmmDeviceAuditMotherboardID = default(string), string rmmDeviceAuditOperatingSystemID = default(string), string rmmDeviceAuditOperatingSystemNameID = default(string), string rmmDeviceAuditOperatingSystemVersionID = default(string), string rmmDeviceAuditPatchStatusID = default(string), string rmmDeviceAuditProcessorID = default(string), string rmmDeviceAuditServicePackID = default(string), string rmmDeviceAuditSNMPContact = default(string), string rmmDeviceAuditSNMPLocation = default(string), string rmmDeviceAuditSNMPName = default(string), string rmmDeviceAuditSoftwareStatusID = default(string), long? rmmDeviceAuditStorageBytes = default(long?), long? rmmDeviceID = default(long?), string rmmDeviceUID = default(string), int? rmmOpenAlertCount = default(int?), string serialNumber = default(string), int? serviceBundleID = default(int?), int? serviceID = default(int?), int? serviceLevelAgreementID = default(int?), double? setupFee = default(double?), int? sourceChargeID = default(int?), int? sourceChargeType = default(int?), string sslSource = default(string), string sslCommonName = default(string), DateTime? sslValidFromDateTime = default(DateTime?), DateTime? sslValidUntilDateTime = default(DateTime?), string sslIssuedBy = default(string), string sslOrganization = default(string), string sslOrganizationUnit = default(string), string sslLocation = default(string), string sslSerialNumber = default(string), string sslSignatureAlgorithm = default(string), int? vendorID = default(int?), DateTime? warrantyExpirationDate = default(DateTime?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ConfigurationItemExtModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemExtModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemExtModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemExtModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RmmDeviceAuditOperatingSystemID == input.RmmDeviceAuditOperatingSystemID ||
                    (this.RmmDeviceAuditOperatingSystemID != null &&
                    this.RmmDeviceAuditOperatingSystemID.Equals(input.RmmDeviceAuditOperatingSystemID))
                ) && 
                (
                    this.RmmDeviceAuditOperatingSystemNameID == input.RmmDeviceAuditOperatingSystemNameID ||
                    (this.RmmDeviceAuditOperatingSystemNameID != null &&
                    this.RmmDeviceAuditOperatingSystemNameID.Equals(input.RmmDeviceAuditOperatingSystemNameID))
                ) && 
                (
                    this.RmmDeviceAuditOperatingSystemVersionID == input.RmmDeviceAuditOperatingSystemVersionID ||
                    (this.RmmDeviceAuditOperatingSystemVersionID != null &&
                    this.RmmDeviceAuditOperatingSystemVersionID.Equals(input.RmmDeviceAuditOperatingSystemVersionID))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RmmDeviceAuditOperatingSystemID != null)
                    hashCode = hashCode * 59 + this.RmmDeviceAuditOperatingSystemID.GetHashCode();
                if (this.RmmDeviceAuditOperatingSystemNameID != null)
                    hashCode = hashCode * 59 + this.RmmDeviceAuditOperatingSystemNameID.GetHashCode();
                if (this.RmmDeviceAuditOperatingSystemVersionID != null)
                    hashCode = hashCode * 59 + this.RmmDeviceAuditOperatingSystemVersionID.GetHashCode();
