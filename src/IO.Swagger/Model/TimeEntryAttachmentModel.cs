...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimeEntryAttachmentModel :  IEquatable<TimeEntryAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeEntryAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TimeEntryAttachmentModel);
        }

        /// <summary>
        /// Returns true if TimeEntryAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeEntryAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeEntryAttachmentModel input)
        {
            if (input == null)
                return false;
