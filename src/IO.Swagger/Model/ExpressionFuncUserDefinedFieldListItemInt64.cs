...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncUserDefinedFieldListItemInt64 :  IEquatable<ExpressionFuncUserDefinedFieldListItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncUserDefinedFieldListItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncUserDefinedFieldListItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncUserDefinedFieldListItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncUserDefinedFieldListItemInt64 input)
        {
            if (input == null)
                return false;
