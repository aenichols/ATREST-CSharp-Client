...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountAlertInt64 :  IEquatable<ExpressionFuncAccountAlertInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountAlertInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountAlertInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountAlertInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountAlertInt64 input)
        {
            if (input == null)
                return false;
