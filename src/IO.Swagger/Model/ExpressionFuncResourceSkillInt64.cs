...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncResourceSkillInt64 :  IEquatable<ExpressionFuncResourceSkillInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncResourceSkillInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncResourceSkillInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncResourceSkillInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncResourceSkillInt64 input)
        {
            if (input == null)
                return false;
