...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountLocationInt64 :  IEquatable<ExpressionFuncAccountLocationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountLocationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountLocationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountLocationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountLocationInt64 input)
        {
            if (input == null)
                return false;
