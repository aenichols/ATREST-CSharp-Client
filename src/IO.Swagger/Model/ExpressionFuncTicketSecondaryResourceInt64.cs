...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketSecondaryResourceInt64 :  IEquatable<ExpressionFuncTicketSecondaryResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketSecondaryResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketSecondaryResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketSecondaryResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketSecondaryResourceInt64 input)
        {
            if (input == null)
                return false;
