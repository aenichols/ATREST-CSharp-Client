...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncChecklistLibraryChecklistItemInt64 :  IEquatable<ExpressionFuncChecklistLibraryChecklistItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncChecklistLibraryChecklistItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncChecklistLibraryChecklistItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncChecklistLibraryChecklistItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncChecklistLibraryChecklistItemInt64 input)
        {
            if (input == null)
                return false;
