...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TicketNoteModel :  IEquatable<TicketNoteModel>, IValidatableObject
    {
        /// <summary>
        ...
        public TicketNoteModel(long? id = default(long?), DateTime? createDateTime = default(DateTime?), int? createdByContactID = default(int?), int? creatorResourceID = default(int?), string description = default(string), int? impersonatorCreatorResourceID = default(int?), int? impersonatorUpdaterResourceID = default(int?), DateTime? lastActivityDate = default(DateTime?), int? noteType = default(int?), int? publish = default(int?), int? ticketID = default(int?), string title = default(string), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TicketNoteModel);
        }

        /// <summary>
        /// Returns true if TicketNoteModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketNoteModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketNoteModel input)
        {
            if (input == null)
                return false;
