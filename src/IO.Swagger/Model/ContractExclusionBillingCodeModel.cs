...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContractExclusionBillingCodeModel :  IEquatable<ContractExclusionBillingCodeModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ContractExclusionBillingCodeModel(long? id = default(long?), long? billingCodeID = default(long?), long? contractID = default(long?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ContractExclusionBillingCodeModel);
        }

        /// <summary>
        /// Returns true if ContractExclusionBillingCodeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractExclusionBillingCodeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractExclusionBillingCodeModel input)
        {
            if (input == null)
                return false;
