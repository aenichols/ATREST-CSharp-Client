...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemNoteAttachmentModel :  IEquatable<ConfigurationItemNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationItemNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConfigurationItemNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemNoteAttachmentModel input)
        {
            if (input == null)
                return false;
