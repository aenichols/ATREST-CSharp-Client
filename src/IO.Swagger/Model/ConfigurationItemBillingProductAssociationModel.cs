...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigurationItemBillingProductAssociationModel :  IEquatable<ConfigurationItemBillingProductAssociationModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ConfigurationItemBillingProductAssociationModel(long? id = default(long?), int? billingProductID = default(int?), int? configurationItemID = default(int?), DateTime? effectiveDate = default(DateTime?), DateTime? expirationDate = default(DateTime?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ConfigurationItemBillingProductAssociationModel);
        }

        /// <summary>
        /// Returns true if ConfigurationItemBillingProductAssociationModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationItemBillingProductAssociationModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationItemBillingProductAssociationModel input)
        {
            if (input == null)
                return false;
