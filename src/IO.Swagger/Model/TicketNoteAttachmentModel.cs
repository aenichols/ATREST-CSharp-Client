...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TicketNoteAttachmentModel :  IEquatable<TicketNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TicketNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if TicketNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketNoteAttachmentModel input)
        {
            if (input == null)
                return false;
