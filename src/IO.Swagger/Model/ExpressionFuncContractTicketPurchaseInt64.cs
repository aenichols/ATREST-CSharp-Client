...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractTicketPurchaseInt64 :  IEquatable<ExpressionFuncContractTicketPurchaseInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractTicketPurchaseInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractTicketPurchaseInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractTicketPurchaseInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractTicketPurchaseInt64 input)
        {
            if (input == null)
                return false;
