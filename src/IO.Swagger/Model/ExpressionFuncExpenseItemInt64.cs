...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncExpenseItemInt64 :  IEquatable<ExpressionFuncExpenseItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncExpenseItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncExpenseItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncExpenseItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncExpenseItemInt64 input)
        {
            if (input == null)
                return false;
