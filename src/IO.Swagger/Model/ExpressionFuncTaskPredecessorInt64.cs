...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTaskPredecessorInt64 :  IEquatable<ExpressionFuncTaskPredecessorInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTaskPredecessorInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTaskPredecessorInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTaskPredecessorInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTaskPredecessorInt64 input)
        {
            if (input == null)
                return false;
