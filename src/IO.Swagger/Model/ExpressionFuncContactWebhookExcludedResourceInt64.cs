...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContactWebhookExcludedResourceInt64 :  IEquatable<ExpressionFuncContactWebhookExcludedResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContactWebhookExcludedResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContactWebhookExcludedResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContactWebhookExcludedResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContactWebhookExcludedResourceInt64 input)
        {
            if (input == null)
                return false;
