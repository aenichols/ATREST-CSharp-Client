...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncInstalledProductCategoryUdfAssociationInt64 :  IEquatable<ExpressionFuncInstalledProductCategoryUdfAssociationInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncInstalledProductCategoryUdfAssociationInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncInstalledProductCategoryUdfAssociationInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncInstalledProductCategoryUdfAssociationInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncInstalledProductCategoryUdfAssociationInt64 input)
        {
            if (input == null)
                return false;
