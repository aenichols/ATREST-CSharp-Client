...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractBillingRuleInt64 :  IEquatable<ExpressionFuncContractBillingRuleInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractBillingRuleInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractBillingRuleInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractBillingRuleInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractBillingRuleInt64 input)
        {
            if (input == null)
                return false;
