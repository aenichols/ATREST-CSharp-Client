...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractRoleCostInt64 :  IEquatable<ExpressionFuncContractRoleCostInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractRoleCostInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractRoleCostInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractRoleCostInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractRoleCostInt64 input)
        {
            if (input == null)
                return false;
