...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractCostInt64 :  IEquatable<ExpressionFuncContractCostInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractCostInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractCostInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractCostInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractCostInt64 input)
        {
            if (input == null)
                return false;
