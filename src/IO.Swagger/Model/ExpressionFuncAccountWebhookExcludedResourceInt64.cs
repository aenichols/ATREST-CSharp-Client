...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncAccountWebhookExcludedResourceInt64 :  IEquatable<ExpressionFuncAccountWebhookExcludedResourceInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncAccountWebhookExcludedResourceInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncAccountWebhookExcludedResourceInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncAccountWebhookExcludedResourceInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncAccountWebhookExcludedResourceInt64 input)
        {
            if (input == null)
                return false;
