...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketRmaCreditInt64 :  IEquatable<ExpressionFuncTicketRmaCreditInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketRmaCreditInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketRmaCreditInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketRmaCreditInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketRmaCreditInt64 input)
        {
            if (input == null)
                return false;
