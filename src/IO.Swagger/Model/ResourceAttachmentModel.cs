...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceAttachmentModel :  IEquatable<ResourceAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ResourceAttachmentModel);
        }

        /// <summary>
        /// Returns true if ResourceAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceAttachmentModel input)
        {
            if (input == null)
                return false;
