...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncContractExclusionAllocationCodeInt64 :  IEquatable<ExpressionFuncContractExclusionAllocationCodeInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncContractExclusionAllocationCodeInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncContractExclusionAllocationCodeInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncContractExclusionAllocationCodeInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncContractExclusionAllocationCodeInt64 input)
        {
            if (input == null)
                return false;
