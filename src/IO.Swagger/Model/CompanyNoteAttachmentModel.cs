...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyNoteAttachmentModel :  IEquatable<CompanyNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CompanyNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if CompanyNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyNoteAttachmentModel input)
        {
            if (input == null)
                return false;
