...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncTicketChecklistItemInt64 :  IEquatable<ExpressionFuncTicketChecklistItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncTicketChecklistItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncTicketChecklistItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncTicketChecklistItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncTicketChecklistItemInt64 input)
        {
            if (input == null)
                return false;
