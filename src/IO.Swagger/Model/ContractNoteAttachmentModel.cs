...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContractNoteAttachmentModel :  IEquatable<ContractNoteAttachmentModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractNoteAttachmentModel" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ContractNoteAttachmentModel);
        }

        /// <summary>
        /// Returns true if ContractNoteAttachmentModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ContractNoteAttachmentModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContractNoteAttachmentModel input)
        {
            if (input == null)
                return false;
