...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyWebhookUdfFieldModel :  IEquatable<CompanyWebhookUdfFieldModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyWebhookUdfFieldModel(long? id = default(long?), bool? isDisplayAlwaysField = default(bool?), bool? isSubscribedField = default(bool?), int? udfFieldID = default(int?), int? webhookID = default(int?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as CompanyWebhookUdfFieldModel);
        }

        /// <summary>
        /// Returns true if CompanyWebhookUdfFieldModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyWebhookUdfFieldModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyWebhookUdfFieldModel input)
        {
            if (input == null)
                return false;
