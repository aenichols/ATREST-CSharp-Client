...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceListProductModel :  IEquatable<PriceListProductModel>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceListProductModel(long? id = default(long?), int? currencyID = default(int?), int? productID = default(int?), double? unitPrice = default(double?), bool? usesInternalCurrencyPrice = default(bool?), List<UserDefinedField> userDefinedFields = default(List<UserDefinedField>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PriceListProductModel);
        }

        /// <summary>
        /// Returns true if PriceListProductModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListProductModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListProductModel input)
        {
            if (input == null)
                return false;
