...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpressionFuncPurchaseOrderItemInt64 :  IEquatable<ExpressionFuncPurchaseOrderItemInt64>, IValidatableObject
    {
        /// <summary>
        /// Defines NodeType
        /// </summary>
        ...
        {
            return this.Equals(input as ExpressionFuncPurchaseOrderItemInt64);
        }

        /// <summary>
        /// Returns true if ExpressionFuncPurchaseOrderItemInt64 instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpressionFuncPurchaseOrderItemInt64 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpressionFuncPurchaseOrderItemInt64 input)
        {
            if (input == null)
                return false;
